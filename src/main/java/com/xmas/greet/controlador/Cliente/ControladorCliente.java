package com.xmas.greet.controlador.Cliente;
...
public class ControladorCliente {
    ...
    public ControladorCliente(ProductService productService, UsuarioServicio usuarioServicio,
            DETALLEService detalleService, PEDIDOService pedidoService) {
    ...
    public String mostrarIndex() {
        return "dashboard-cliente/index";
    }
	...
	public String mostrarCatalogo(Model model) {
		...
		return "dashboard-cliente/catalogo";
	}
...
public String informacionById(@PathVariable("product_id") String productId, Model model) {
    ...
    if (productOptional.isEmpty()) {
        return "redirect:/cliente/catalogo"; // Redirige al catálogo si el producto no existe
    }
...
public String formPedido( Model model) {
    ...
    @GetMapping("/perfil")
    public String obtenerUsuarioLogeado(Authentication authentication, Model model) {
